...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  budgets = {
     ...
     * @secure
     */
    createAccount: (budgetId: string, data: SaveAccountWrapper, params: RequestParams = {}) =>
     ...
     * @secure
     */
    createTransaction: (budgetId: string, data: SaveTransactionsWrapper, params: RequestParams = {}) =>
     ...
     * @secure
     */
    updateTransactions: (budgetId: string, data: UpdateTransactionsWrapper, params: RequestParams = {}) =>
      this.request<SaveTransactionsResponse, ErrorResponse>({
        path: `/budgets/${budgetId}/transactions`,
        method: "PATCH",
        body: data,
